var v=d=>{throw TypeError(d)};var w=(d,e,t)=>e.has(d)||v("Cannot "+t);var s=(d,e,t)=>(w(d,e,"read from private field"),t?t.call(d):e.get(d)),p=(d,e,t)=>e.has(d)?v("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(d):e.set(d,t);var c=(d,e,t)=>(w(d,e,"access private method"),t);const C=`
<style>
.ls-item {
    padding: 1.25rem;
    width: 100%;
...
`;var i,n,u,b,y,E,m,x,L,k,A,S;class I extends HTMLElement{constructor(){super();p(this,n);p(this,i,{routes:[],curPage:"",isDone:!0,isHidden:!1});const t=this.attachShadow({mode:"open"});t.innerHTML=`
            ${D}
